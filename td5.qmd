...
mse_A10_1d <- mse(y, a10_forecasts_1d)
mse_A3_1d <- mse(y, a3_forecasts_1d)
mse_RW_1d <- mse(y, rw_forecasts_1d)

mse_A10_5d <- mse(y, a10_forecasts_5d)
mse_A3_5d <- mse(y, a3_forecasts_5d)
mse_RW_5d <- mse(y, rw_forecasts_5d)
```
